...
namespace eCoinAccountingApp.Data.Migrations
{
    ...
    [Migration("20241028031324_AddDocumentPathToJournal")]
    partial class AddDocumentPathToJournal
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eCoinAccountingApp.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("eCoinAccountingApp.Data.PasswordHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eCoinAccountingApp.Models.EventLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("eCoinAccountingApp.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("eCoinAccountingApp.Data.PasswordHistory", b =>
                {
                    b.HasOne("eCoinAccountingApp.Data.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("eCoinAccountingApp.Models.Account", b =>
                {
                    b.HasOne("eCoinAccountingApp.Models.Company", "Company")
                        .WithMany("Accounts")
